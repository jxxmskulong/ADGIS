...
/**
 *
 * Created by xiati on 2018/3/6.
 */

public class ClearAutoCompleteTextView extends AppCompatAutoCompleteTextView implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            ...
            mClearDrawable = getResources().getDrawable(R.drawable.ic_clear_edittext_close);
        }
